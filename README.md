...
### How It Behaves
Arithmetic operations are restricted to the selected bit-size. Overflow with truncation, 2's complement representation of negative integers, and integer division can be expected. To perform conversions, enter the binary input and press the equals button.
